...
public class ValidateAPIConnector {

    private URL url;
    private String user;
    private String ltoken;

    public ValidateAPIConnector(String url, String user, String ltoken) throws IOException {
    ...
    public JSONArray sendRequest(String request) throws IOException {
        ...
        try {
            ...
            throw new IOException(
                    "Error: connection to Validate Server \"" + url.toString()
                            + "\" failed.\n" + "Request: "
                            + request + "\n" + "Cause: "
                            + ex.getMessage(),
                    ex);
        ...
        if (!success) {
            throw new IOException("Error: request was not successfully handled by Validate server \"" + url.toString()
                    + "\".\n" + "Request: "
                    + request + "\n" + "Return: "
                    + errorMsg);
        }
